 ...
 *        category entered Validate user inputs Standardize category codes by
 *        displaying a menu of categories and having the user enter category by
 *        number instead of name Display movies sorted alphabetically
 *
 */
